...
router.get('/:pacienteId/remediosSemEstoque', controller.estoqueRemedio)
router.get('/:pacienteId/remedios/:remedioId/ProximoConsumo', controller.proximoConsumo)
router.patch('/:pacienteId/remedios/:remedioId/consumir', controller.consumir)
